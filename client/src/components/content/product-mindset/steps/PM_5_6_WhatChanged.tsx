...
export default function PM_5_6_WhatChanged({ onNext }: Props) {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-4">What Changed</h1>
      <div className="bg-gray-50 rounded-lg p-8 text-center text-gray-500">
        <p className="text-lg mb-2">Content coming soon</p>
        <p className="text-sm">Step pm-5-6</p>
      </div>
      {onNext && (
        <div className="mt-8 flex justify-end">
          <button
            onClick={() => onNext('pm-5-7')}
