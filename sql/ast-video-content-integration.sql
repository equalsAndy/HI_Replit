...
-- Comprehensive 9-step AST video mapping with transcripts and glossaries
-- Fixes duplicate video IDs and establishes proper step-to-video mapping

-- Clear existing AST videos to start fresh
DELETE FROM videos WHERE workshop_type = 'allstarteams' OR "workshopType" = 'allstarteams';
...
-- AST Step 1-2: The Self-Awareness Opportunity (Previously "Positive Psychology")
INSERT INTO videos (
  title, description, url, "editableId", "workshopType", section, "stepId", autoplay, "sortOrder",
  "transcriptMd", glossary, "createdAt", "updatedAt"
) VALUES (
...
-- AST Step 2-1: Star Strengths Assessment Introduction
INSERT INTO videos (
  title, description, url, "editableId", "workshopType", section, "stepId", autoplay, "sortOrder",
  "transcriptMd", glossary, "createdAt", "updatedAt"
) VALUES (
...
-- AST Step 2-3: Review Your Star Card
INSERT INTO videos (
  title, description, url, "editableId", "workshopType", section, "stepId", autoplay, "sortOrder",
  "transcriptMd", glossary, "createdAt", "updatedAt"
) VALUES (
...
-- AST Step 3-1: Well-Being Ladder (FIXED - moved from incorrect 4-1 position)
INSERT INTO videos (
  title, description, url, "editableId", "workshopType", section, "stepId", autoplay, "sortOrder",
  "transcriptMd", glossary, "createdAt", "updatedAt"
) VALUES (
...
-- AST Step 5-1: Your Future Self (FIXED - moved to correct 5-1 position, was incorrectly at 4-4)
INSERT INTO videos (
  title, description, url, "editableId", "workshopType", section, "stepId", autoplay, "sortOrder",
  "transcriptMd", glossary, "createdAt", "updatedAt"
) VALUES (
...
-- Verification query to show the complete AST video structure
SELECT 
  "stepId",
  title,
  section,
