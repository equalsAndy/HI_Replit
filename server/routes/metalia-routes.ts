 ...
 * METAlia Routes
 * ==============
 * API endpoints for the METAlia (Meta-Talia) system
 * Handles escalations, conversation analysis, and persona coordination
 */
 ...
 * Used by Talia personas when they need help or clarification
 */
router.post('/escalations', async (req, res) => {
  try {
    ...
    // Create escalation using the conversation logging service
...
/**
 * Get pending escalations (admin-only)
 * Returns escalations that need admin attention
 */
 ...
 * Marks an escalation as resolved with admin response
 */
 ...
 * Provides insights into persona performance and conversation patterns
 */
 ...
 * Returns conversation logs for METAlia analysis
 */
 ...
 * Allows adding user feedback to conversations
 */
 ...
 * Returns aggregated performance data for personas
 */
