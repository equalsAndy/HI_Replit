...
router.post('/create', async (req, res) => {
  try {
    ...
    const userData = {
      ...
      profilePicture: null,
      isTestUser: true, // Mark as test user for beta testers
      contentAccess: 'professional' as const, // Give beta testers professional access
      astAccess: true,
      iaAccess: true,
      inviteCode: inviteCode || null,
      betaTester: true // Custom field to identify beta testers
    };
...
/**
 * Check if an invite code is for beta testing
 */
router.post('/check-invite', async (req, res) => {
  try {
    ...
    // Simple beta detection logic - you can make this more sophisticated
    // Check if invite code contains "beta", "test", or starts with "BETA"
