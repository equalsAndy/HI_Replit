...
// ===================================================================
// ENDPOINT: POST /api/processing/documents/:id/process
// Trigger processing (chunking and embedding) for a specific document
// ===================================================================
router.post('/documents/:id/process', requireAuth, requireAdmin, async (req, res) => {
  try {
    ...
    // Start processing asynchronously (using text search service)
...
// ===================================================================
// ENDPOINT: POST /api/processing/documents/process-pending
...
// ===================================================================
// ENDPOINT: GET /api/processing/documents/:id/status
...
// ===================================================================
// ENDPOINT: POST /api/processing/search/similar
...
// ===================================================================
// ENDPOINT: DELETE /api/processing/documents/:id/chunks
// Delete all chunks for a specific document (to reprocess)
// ===================================================================
router.delete('/documents/:id/chunks', requireAuth, requireAdmin, async (req, res) => {
  try {
    ...
    // Mark any processing jobs as cancelled
    await pool.query(`
