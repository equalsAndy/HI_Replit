...
import aiComparisonRoutes from './routes/ai-comparison-routes.ts';
import imageGenRouter from './routes/image-gen.ts';
import iaContinuityRoutes from './routes/ia.ts';
import iaSnapshotRoutes from './routes/ia-snapshot-routes.ts';
...
app.use('/api/admin/ai', assistantTestRoutes);
      ...
      app.use('/api/ia', iaSnapshotRoutes);
