...
async function addWorkshopVideos() {
  ...
  const imaginalAgilityVideos = [
    ...
    },
    {
      ...
      description: "Understanding the three cascading challenges of AI",
    ...
    },
    {
      ...
      description: "The solution to develop imaginal agility",
    ...
    },
    {
      ...
      description: "Preparing for team collaboration",
    ...
    },
    {
      ...
      description: "Reality discernment training guide",
    ...
    },
    {
      ...
      description: "The neuroscience behind imaginal agility",
    ...
    },
    {
      ...
      description: "Additional information about the workshop",
      url: "https://www.youtube.com/embed/8Q5G3CF3yxI?enablejsapi=1&autoplay=1&rel=0",
      editableId: "8Q5G3CF3yxI",
      workshopType: "imaginal-agility",
      section: "ia-8-1",
      stepId: "ia-8-1",
      autoplay: true,
