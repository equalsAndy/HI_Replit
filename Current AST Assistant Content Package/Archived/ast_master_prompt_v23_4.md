...
# Master Prompt – AST Personal Development Report (v23.4)
...
- Flow attributes represent **states of optimal engagement**, not fixed traits. Write as interpretation, not definition.
...
- **Section 1 – Strengths & Imagination**  
  ...
  Include explicit shape identification and compare with one or two contrasting shapes.  
  Do not include StarCard visuals—those are injected by the app.  

- **Section 2 – Flow State Analysis & Optimization**  
  Use: `section2_flow_experiences_instruction_active_v13.md`  
...
- Active instruction files (v6–v13 as listed above).  
- Data mapping file:  
  - `ast_data_mapping_active.md`  
- Reference guides:  
  - `strengths_patterns_and_shapes_active_v2.md`  
  - `flow_attribute_comparison.md`  
- Compendiums:  
