#!/bin/bash
# Staging deployment for v2.0.15
# Date: 2025-07-26
# Changes: 
# - Fixed beta tester toggle persistence
# - Enable feedback system for staging environment
# - Show feedback button for test users and beta testers
...
sudo docker pull 962000089613.dkr.ecr.us-west-2.amazonaws.com/hi-replit-app:staging-20250726-2225
sudo docker run -d --name staging-app -p 80:8080 --env-file staging.env --restart unless-stopped 962000089613.dkr.ecr.us-west-2.amazonaws.com/hi-replit-app:staging-20250726-2225
...
echo ""
echo "Changes in v2.0.15:"
echo "- Beta tester toggle now persists correctly"
echo "- Feedback system enabled for staging"
echo "- Feedback button shows for test users and beta testers"